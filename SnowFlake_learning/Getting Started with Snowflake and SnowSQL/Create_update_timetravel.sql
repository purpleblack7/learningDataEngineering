...
('d01d-w7pxHrMCX5mDwaaHQ','D Liche','MontrÈal','QC',89,4.5),
('66DKb6APF96InEKrUVIbZw','Allo Inde','MontrÈal','QC',3,3.5);
...
SELECT * FROM BUSINESSES AT(timestamp => '2021-08-24 15:16:27.246 +0000':: timestamp)
WHERE City = 'Las Vegas';
